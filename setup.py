...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    download_url='https://github.com:trytonspain/trytond-account_bank_statement_counterpart',
    ...
    project_urls = {
       "Source Code": 'https://github.com:trytonspain/trytond-account_bank_statement_counterpart'
    },
    classifiers=[
